...
from models import (Resume, Media, CertificateBlock, SkillBlock, Sphere, SphereTranslation, Profession,
...
sphere = SphereCrud(Sphere, SphereTranslation)
profession = ProfessionCrud(Profession, ProfessionTranslation)
